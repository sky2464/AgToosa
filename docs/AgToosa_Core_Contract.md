...
>
> **Maintainer mirror:** This repository keeps `docs/AgToosa_Core_Contract.md`. Generated projects install `Docs/AgToosa_Core_Contract.md` from `template/Docs/AgToosa_Core_Contract.md`. Inventory paths below use the generator `Docs/` prefix (and other relative paths) exactly as listed in `lib/config.sh`.
...
- Authoring / onboarding: `docs/extension-authoring-guide.md`, `docs/registry-pack-authoring.md` (maintainer); help adapters link the GitHub blob URLs
