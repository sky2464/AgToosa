...
| Release | `https://github.com/sky2464/AgToosa/releases/tag/v0.3.59` opens without authentication |
...
| Pinned Bash bootstrap | `https://raw.githubusercontent.com/sky2464/AgToosa/v0.3.59/bootstrap.sh` returns HTTP 200 |
...
curl -fsSL https://raw.githubusercontent.com/sky2464/AgToosa/v0.3.59/bootstrap.sh >/tmp/agtoosa-bootstrap-v0.3.59.sh
