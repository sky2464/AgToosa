...
| Release | `https://github.com/sky2464/AgToosa/releases/tag/v5.3.58` opens without authentication |
...
| Pinned Bash bootstrap | `https://raw.githubusercontent.com/sky2464/AgToosa/v5.3.58/bootstrap.sh` returns HTTP 200 |
...
curl -fsSL https://raw.githubusercontent.com/sky2464/AgToosa/v5.3.58/bootstrap.sh >/tmp/agtoosa-bootstrap-v5.3.58.sh
