...
|----|---------|------------|------|-----------------|--------|
| AC-001 | JIO-001 | Catalog plan emits DEV-090 JSON schema | Integration | `jq` parse OK; required plan fields present | ⬜ Planned `@smoke` |
...
|------------|-----------------|-----------|--------------|
| 2. Implementation | `bats tests/agtoosa.bats -f "DEV-100\|JIO-"` | 0 | `ok 1` through `ok 7`; JIO-004 no ANSI |
