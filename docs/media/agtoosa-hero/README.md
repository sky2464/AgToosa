...
| `ReadmeLoop` | 24s | Readable cinematic README motion | Silent |
...
- The silent README loop gives status, init, workflow, routing, verification,
  and closing-brand scenes deliberate reading holds. It exports all 720 frames
  at 30fps with larger display typography and an 800×450 source for smooth,
  legible inline playback without a separate media link.
