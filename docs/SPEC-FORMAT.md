...
> **Path note:** Examples use `docs/` for **Maintainer Dogfood Mode** (this repository). Generated installs use `Docs/` with the same relative layout — see `docs/agtoosa-maintainer.md` → Path conventions.
