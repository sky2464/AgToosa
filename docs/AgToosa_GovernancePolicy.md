...
> Schema version: 1 · Checker: `docs/agtoosa-policy-check.sh`
...
3. `docs/Context/agtoosa-policy.yaml` (maintainer dogfood Context fallback; generated projects use `Docs/Context/agtoosa-policy.yaml`)
