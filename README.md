...
[![Version](https://img.shields.io/badge/version-5.3.4-green.svg)](https://github.com/sky2464/AgToosa/releases)
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/sky2464/AgToosa/main/bootstrap.sh) --ref v5.3.4
```
