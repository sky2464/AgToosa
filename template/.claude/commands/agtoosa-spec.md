...
- `research <topic>` → execute Part 1 only: context gathering, external research, and 6 forcing questions. Output findings; do not write a spec file yet.
...
- `grill` → domain language grilling session: align terminology with CONTEXT.md, update it, create ADRs, then proceed to full spec.
