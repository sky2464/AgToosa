---
name: agtoosa-init
description: Run one-time AgToosa project initialization — context, AI configs, epics, and optional project skill discovery.
---
...
3. Complete Project Skill Discovery when applicable; require **explicit user approval** before writing any new `.codex/skills/<skill-name>/SKILL.md` file.
