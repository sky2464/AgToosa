...
**Start here:** `/agtoosa-next` — primary sequential driver.
...
For `next`: same routing as `/agtoosa-next dry` per `Docs/AgToosa_Next.md`; end with `To execute: /agtoosa-next`. Do not auto-run mutating workflows from help.
