...
.PARAMETER TrackerCommand
    Tracker sub-command: export, propose, publish, intake, discover, bootstrap, or status-check.
...
${BOLD}Tracker:${NC}
  ...
  -Tracker -TrackerCommand status-check -Path <dir>  Unlinked external tracker JSON (stdout)
