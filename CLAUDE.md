...
**Freeform asks** without `/agtoosa-*` trigger **AgToosa Project Intake** per `docs/AgToosa_Agent.md` → Project Intake Protocol (including Natural Language Intent Map). Always-on detail: `.cursor/rules/agtoosa-maintainer-core.mdc`.
